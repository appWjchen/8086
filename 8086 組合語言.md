...
![](C:\Users\user\Documents\Images\2024-07-21-07-12-57-image.png)

下載完成後，在你的「下載(Download)」資料夾中會有一個 DOSBox0.74-3-win32-installer.exe 檔案，如下圖，雙擊(double click)該檔案即可開始安裝 DOSBOX：

![](C:\Users\user\Documents\Images\2024-07-21-07-34-47-image.png)

接著會跳出使用者帳戶控制視窗，請務必要按「是」，啟動安裝程式，

然後出現如下圖安裝視窗，請按「Next>」繼續：

<img src="C:\Users\user\Documents\Images\2024-07-21-09-18-45-image.png" title="" alt="" width="450">

下一個視窗(如下圖)，請繼續按「Next>」：

<img src="C:\Users\user\Documents\Images\2024-07-21-09-20-26-image.png" title="" alt="" width="449">

接著出現安裝路徑視窗，若有必要，請記下此安裝路徑，請按下「Install」開始安裝：

<img src="C:\Users\user\Documents\Images\2024-07-21-09-21-54-image.png" title="" alt="" width="451">

最後，安裝完成後會如下圖，請按「Close」結束安裝。

<img src="C:\Users\user\Documents\Images\2024-07-21-09-22-56-image.png" title="" alt="" width="453">

#### DOSBox 設定

安裝好 DOSBox 後，要先設定它才好使用，包括要模擬的 DOS 機器的記憶體大小，和啟動的程式等等。請從開始功能表找到 DOSBox 0.74-3 Options ，點擊它可以用記事本打開 DOSBox 設定檔案：

![](C:\Users\user\Documents\Images\2024-07-21-10-35-05-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-10-58-29-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-11-03-35-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-11-10-23-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-12-53-51-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-13-10-55-image.png)

接著打開解壓縮之後的資料夾，裡面有三個 .img 的檔案，這是 DOS 4 的三張軟碟映像檔，可以如上圖方式，用 7-zip 在三個檔案上按右鍵解壓出三個資料夾。

![](C:\Users\user\Documents\Images\2024-07-21-13-12-39-image.png)

三個資料夾解壓之後，如下圖所示：

![](C:\Users\user\Documents\Images\2024-07-21-13-14-18-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-13-40-25-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-14-06-51-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-14-27-25-image.png)

下載完成後，在「下載」資料夾(C:\Users\user\Download)中，有一個 DJGPP_Development_System_August_1998.iso 檔案，如下圖，在其上連點二下，即可掛載到你的 Windows 系統上：

![](C:\Users\user\Documents\Images\2024-07-21-14-34-39-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-14-52-11-image.png)

按下 Enter 鍵繼續，待出現如下畫面時：

![](C:\Users\user\Documents\Images\2024-07-21-14-53-47-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-15-21-04-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-21-15-32-12-image.png)

打好程式後存檔，如上圖所示，然後打開 DOSBox ，依下圖所示操作：

![](C:\Users\user\Documents\Images\2024-07-21-16-59-33-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-07-00-59-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-07-03-05-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-07-09-22-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-07-22-06-image.png)

改完的 makefile 如下：

![](C:\Users\user\Documents\Images\2024-07-23-07-27-43-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-07-26-48-image.png)

我們用編輯器來打開 type.h ，找到 175 行 umask 的段落，如下圖：

![](C:\Users\user\Documents\Images\2024-07-23-07-35-46-image.png)

出問題的那段是在 #ifdef MY_STAT_H ，我們用系統的 sys/stat.h 就好，直接把這段註解掉，如下圖。

![](C:\Users\user\Documents\Images\2024-07-23-07-37-42-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-07-42-44-image.png)

改完後再次 make 出現下圖問題：

![](C:\Users\user\Documents\Images\2024-07-23-07-47-14-image.png)

再次編輯 type.h ，找到第 204 行 #include <unistd.h> 將其註解掉。重新 make，出現如下圖問題：

![](C:\Users\user\Documents\Images\2024-07-23-07-49-49-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-08-03-46-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-07-11-57-48-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-06-09-33-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-13-33-55-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-23-13-57-47-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-01-18-30-42-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-03-08-18-48-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-03-08-54-40-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-03-08-52-38-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-04-09-10-00-image.png)
...
>     c:\tmp\test> test.exe
> 
> ![](C:\Users\user\Documents\Images\2024-08-05-14-38-51-image.png)
> 
> 再用 hexdump 程式去看 temp.obj 的內容，將看到變成了 B8 0D 0A 00，所以在 DOS 中寫 C 語言程式，用到 write 函式要小心，建議改用 fopen 及 fwrite 寫出 binary 檔案。
> 
> ![](C:\Users\user\Documents\Images\2024-08-05-14-45-31-image.png)
> 
...
![](C:\Users\user\Documents\Images\2024-08-04-13-53-01-image.png)  
...
![](C:\Users\user\Documents\Images\2024-08-04-14-13-41-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-04-14-38-52-image.png)

除了上圖中的二個區域，我們的組合語言程式不要去亂動外，還有 DOS 作業系統程式所佔用的記憶體，我們也不要去亂動它，這些記憶體區段是 ROM BIOS 從磁碟中載入 DOS 到記憶體中，並且經過 DOS 程式初始化後所佔用的區域。

![](C:\Users\user\Documents\Images\2024-08-05-15-28-09-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-06-07-56-25-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-06-09-59-15-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-06-14-30-23-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-07-13-31-41-image.png)
...
![](C:\Users\user\Documents\Images\2024-08-07-16-07-30-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-22-08-12-37-image.png)

3. 接著它會變成下圖，請按「允許」，這樣以後 DOSBox 的 C:\ 磁碟就是這個目錄了。

![](C:\Users\user\Documents\Images\2024-07-22-08-15-11-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-22-08-33-01-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-22-06-17-44-image.png)
...
![](C:\Users\user\Documents\Images\2024-07-22-06-21-31-image.png)

此時可以按 b 鍵，開始簡單模式遊戲，或者 n 鍵開始正常遊戲模式，...

請自己玩看看，操作方式以下圖參考，注意是傳統 Apple II 的鍵盤，和現今鍵盤對應起來也差不多。

![](C:\Users\user\Documents\Images\2024-07-22-06-25-08-image.png)
